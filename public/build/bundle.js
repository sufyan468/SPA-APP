...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "https://lh3.googleusercontent.com/-i-GSim_JIgE/Ycw1T_0exxI/AAAAAAAAEUo/NOZmwPewX8Q7gx6iblvYB8xsWkXSLS2IwCEwYBhgLKtQDABHVOhx28qoi8ed8npzjfpcUl-IXH03rMsu0NXY6ZwjrzNWfIv8PjzyAbvzFEYgVUVVEcaXHNeVqCvAEAN-UqE-xcCV-OwPpI0u9wuK-K_a6z-e5JNCICveT1eSxyLiiYjC8DLwciFil9WovdKgEYbQo2bV7AM8qoy8NvV7jDC5O-Z5mfuiwAyYss4uB2G0Icr3Xk6sUimbiREznlfzL1991O-na7xHHswYW5fpdaSIqV6kVBkB0YE6dK8XDPu0gcKyRWxDsBETPYeChTh3TV--YRz5T6PHbeJ3M5a82YAopH1uN0ubu8fMzRvTZt4Zgh7-Z72GfKArhTA_U1rpTQ-Cb_H7GVt-WGWv7CGd2WUDtC8zv1su17SvGdXtVRtS5nRrmMO9XWYrUu-Dri0tRb2UA_MOc5u6FCS48VkM0YjoTBw7aarY6o_HJ4BTcFfTcsuFMPD0nBwZQ0cLTMivf0xrWmU_3IG1si2kkBt28Q9lpAszIHDWBMlIj4kUQt9yYMQhswCyyVk6H0z_qCo1TnCGLluzOR9S7YK_KvD9Oc_tpo3ygDuiwRSeGnV1yAkDHfq_4FQAsgCeMnwoZejpQKVSLSRxzCas0-TeMQUkHx-YYoyauMLXvsI4G/w280-h218-p/vectore-removebg-preview.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "How it works");
    			add_location(img, file, 23, 10, 948);
    			attr_dev(i, "class", "fa fa-play");
    			attr_dev(i, "aria-hidden", "true");
    			add_location(i, file, 29, 14, 1873);
    			add_location(button, file, 28, 12, 1850);
    			attr_dev(div3, "class", "play_btn");
    			add_location(div3, file, 27, 10, 1815);
    ...
    const file$6 = "src/routes/ContactUS.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$6, 6, 8, 163);
    			add_location(p, file$6, 8, 10, 270);
    			attr_dev(div0, "id", "emailHelp");
    			attr_dev(div0, "class", "form-text");
    			add_location(div0, file$6, 7, 8, 221);
    			attr_dev(div1, "class", "col-lg-5 col-sm-12 p-3");
    			add_location(div1, file$6, 5, 6, 118);
    			attr_dev(label0, "for", "exampleInputEmail1");
    			attr_dev(label0, "class", "form-label");
    			add_location(label0, file$6, 21, 12, 822);
    ...
    const file$8 = "src/routes/Header.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div10 = element("div");
    			img1 = element("img");
    			attr_dev(div0, "class", "hero_bg_box svelte-s63f1y");
    			add_location(div0, file$8, 16, 2, 286);
    			if (img0.src !== (img0_src_value = "https://blogger.googleusercontent.com/img/a/AVvXsEi-JWOvGCAdYsg0KcLYS5CNEfcD79S9vZVWRVDnEvdxU9Tr92Ki5Br-y6vQbpfxGahewNkPTS47EXlPkv7inyfTMXStSrrU_on-rnsCd-hAUr3XdyopommFUvaTpYFj33qtA2WsOyb8u9cflCBAoOHBSYfIIXVZeeQwmmAMAeQ1FmKMopvQemaJfNiEXA=s1200")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "User");
    			attr_dev(img0, "class", "LogoImage ");
    			add_location(img0, file$8, 22, 10, 533);
    			attr_dev(b, "class", "ms-2");
    			add_location(b, file$8, 27, 10, 878);
    			attr_dev(a0, "class", "navbar-brand  text-white d-flex align-items-center");
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$8, 21, 8, 451);
    			attr_dev(span, "class", "");
    			add_location(span, file$8, 31, 10, 1006);
    			attr_dev(button0, "class", "navbar-toggler");
    			attr_dev(button0, "type", "button");
    			add_location(button0, file$8, 30, 8, 931);
    			attr_dev(a1, "class", "nav-link");
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$8, 40, 14, 1278);
    			attr_dev(li0, "class", "nav-item active svelte-s63f1y");
    			add_location(li0, file$8, 39, 12, 1235);
    			attr_dev(a2, "href", "/#/Services");
    			attr_dev(a2, "class", "nav-link");
    			add_location(a2, file$8, 45, 14, 1459);
    			attr_dev(li1, "class", "nav-item svelte-s63f1y");
    			add_location(li1, file$8, 43, 12, 1348);
    			attr_dev(a3, "class", "nav-link");
    			attr_dev(a3, "href", "/#/about");
    			add_location(a3, file$8, 48, 14, 1577);
    			attr_dev(li2, "class", "nav-item svelte-s63f1y");
    			add_location(li2, file$8, 47, 12, 1541);
    			attr_dev(a4, "class", "nav-link");
    			attr_dev(a4, "href", "/#/contact");
    			add_location(a4, file$8, 51, 14, 1690);
    			attr_dev(li3, "class", "nav-item svelte-s63f1y");
    			add_location(li3, file$8, 50, 12, 1654);
    			...
    			add_location(path, file$8, 63, 18, 2148);
    			...
    			add_location(svg, file$8, 55, 17, 1882);
    			attr_dev(button1, "class", "nav-link bar-toggler svelte-s63f1y");
    			add_location(button1, file$8, 54, 14, 1828);
    			attr_dev(li4, "class", "nav-item svelte-s63f1y");
    			add_location(li4, file$8, 53, 12, 1773);
    			attr_dev(ul, "class", "navbar-nav  ");
    			set_style(ul, "margin-top", "0px");
    			add_location(ul, file$8, 38, 10, 1172);
    			attr_dev(div1, "class", "collapse navbar-collapse HeaderPosition svelte-s63f1y");
    			attr_dev(div1, "id", "navbarSupportedContent");
    			add_location(div1, file$8, 34, 8, 1051);
    			attr_dev(nav, "class", "navbar navbar-expand-lg custom_nav-container ");
    			add_location(nav, file$8, 20, 6, 383);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$8, 19, 4, 353);
    			attr_dev(header, "class", "header_section");
    			add_location(header, file$8, 18, 2, 317);
    			attr_dev(button2, "class", "closeNavbar float-end svelte-s63f1y");
    			add_location(button2, file$8, 80, 10, 2747);
    			attr_dev(div3, "class", "flex-fill justify-content-end");
    			add_location(div3, file$8, 79, 8, 2693);
    			attr_dev(div4, "class", "w-100 d-flex");
    			add_location(div4, file$8, 78, 6, 2658);
    			attr_dev(a5, "class", "nav-link text-white");
    			attr_dev(a5, "href", "/");
    			add_location(a5, file$8, 86, 8, 2933);
    			attr_dev(li5, "class", "nav-item active offcanvas-body-li svelte-s63f1y");
    			add_location(li5, file$8, 85, 6, 2878);
    			attr_dev(a6, "class", "nav-link text-white");
    			attr_dev(a6, "href", "/#/services");
    			add_location(a6, file$8, 90, 8, 3050);
    			attr_dev(li6, "class", "nav-item offcanvas-body-li svelte-s63f1y");
    			add_location(li6, file$8, 89, 6, 3002);
    			attr_dev(a7, "class", "nav-link text-white");
    			attr_dev(a7, "href", "/#/about");
    			add_location(a7, file$8, 93, 8, 3179);
    			attr_dev(li7, "class", "nav-item offcanvas-body-li svelte-s63f1y");
    			add_location(li7, file$8, 92, 6, 3131);
    			attr_dev(a8, "class", "nav-link text-white");
    			attr_dev(a8, "href", "/#/contact");
    			add_location(a8, file$8, 96, 8, 3303);
    			attr_dev(li8, "class", "nav-item offcanvas-body-li svelte-s63f1y");
    			add_location(li8, file$8, 95, 6, 3255);
    			attr_dev(div5, "class", "offcanvas-body svelte-s63f1y");
    			add_location(div5, file$8, 77, 4, 2623);
    			attr_dev(div6, "class", "sidenav svelte-s63f1y");
    			attr_dev(div6, "id", "mySidenav");
    			set_style(div6, "width", /*navWidth*/ ctx[0] + "%");
    			add_location(div6, file$8, 76, 2, 2555);
    			add_location(br, file$8, 106, 25, 3597);
    			add_location(h1, file$8, 105, 12, 3567);
    			attr_dev(p, "class", "text-white text-left");
    			add_location(p, file$8, 109, 12, 3665);
    			attr_dev(a9, "href", "#ReaMore");
    			attr_dev(a9, "class", "btn1");
    			add_location(a9, file$8, 116, 14, 4070);
    			attr_dev(div7, "class", "btn-box text-left");
    			add_location(div7, file$8, 115, 12, 4024);
    			attr_dev(div8, "class", "detail-box");
    			add_location(div8, file$8, 104, 10, 3530);
    			attr_dev(div9, "class", "col-md-6 ");
    			add_location(div9, file$8, 103, 8, 3496);
    			if (img1.src !== (img1_src_value = "https://tutorbees.net/assets/new_ui/sub-1.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "title", "New image");
    			attr_dev(img1, "alt", "Sub 1");
    			attr_dev(img1, "class", "Slider-Image svelte-s63f1y");
    			add_location(img1, file$8, 122, 12, 4251);
    			attr_dev(div10, "class", "img-box-Header");
    			add_location(div10, file$8, 121, 10, 4210);
    			attr_dev(div11, "class", "col-md-6");
    			add_location(div11, file$8, 120, 8, 4177);
    			attr_dev(div12, "class", "row");
    			add_location(div12, file$8, 102, 6, 3470);
    			attr_dev(div13, "class", "container ");
    			add_location(div13, file$8, 101, 4, 3439);
    			attr_dev(section, "class", "slider_section ");
    			add_location(section, file$8, 100, 2, 3401);
    			attr_dev(div14, "class", "hero_area");
    			add_location(div14, file$8, 15, 0, 260);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$9, 6, 13, 99);
    			attr_dev(a, "href", "https://github.com/sufyan468");
    			attr_dev(a, "target", "blank");
    			add_location(a, file$9, 7, 6, 154);
    			add_location(p, file$9, 5, 4, 82);
    			attr_dev(div, "class", "container");
    			add_location(div, file$9, 4, 2, 54);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$a, 7, 0, 193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
